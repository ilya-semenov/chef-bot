...
# Приветственное сообщение (С ТОЧНОЙ ФОРМУЛИРОВКОЙ ПРО ИЛЬЮ)
WELCOME_MESSAGE = """
...
async def cmd_random(message: Message):
    ...
    random_dishes = [
        "куриная грудка, снизить калории", 
        "овощное рагу, сохранить витамины", 
        "рыба на пару, полезный ужин", 
        "греческий салат, легкий обед",
        "индейка с овощами, убрать вредные жиры",
        "киноа с овощами, здоровый обед"
    ]
    import random
